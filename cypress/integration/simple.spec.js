context('Registering with existing username', () => {
  ...
  it('makes a correct login attemp', () => {
    ...
    cy.screenshot('Login_fallido_usuario_existente');
  })
});
...
context('Login Tests', () => {
  ...
  it('makes a correct login attemp', () => {
    ...
    cy.screenshot('Succesfully_login');
  })
});
...
;
    ...
    cy.screenshot('Create_test_alert');
    cy.wait(500);
...
context('Create daily task', () => {
  ...
  it('Succesfully creates a daily task of skincare', () => {
    ...
    cy.wait(500);
    cy.get('.task-modal-footer > .btn').click();
    cy.screenshot('Habit_and_task_created');
